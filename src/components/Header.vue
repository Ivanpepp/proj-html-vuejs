<template>
  <header>
      <!-- Top nav section -->
        <section id="top-nav" class="pt-1">
            <div class="container">
                <div class="row">
                    <div class="col-1 language d-flex align-items-center">
                    ...
                    <div class="col-11">
                        ...
                        <ul class="d-flex justify-content-end m-0 ">
                            <li class="  text-center" v-for="(link,index) in topHeader" :key='index'>
                                <a class="px-2" href="#">
                                    {{link.type}} <span v-if="link.new===true" class="new">new</span>
                                </a>
                            </li>
                        <!-- Social Section -->
                ...
                <div class="row">
                    <div class="col-12 d-flex  align-items-center ">
                        ...
                        <div class="ms-4 d-flex align-items-center flex-grow-1">
                            ...
                            <input @keyup="$emit('search', needle)" @keyup.enter='filterCourse' v-model.trim="needle" type="text" class="ms-2 form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-lg" placeholder="Search courses">
...
<script>
import topHeader from '../data/top-header.js'
